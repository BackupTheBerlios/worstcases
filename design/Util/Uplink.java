...
/**
 * Versendet Nachrichten über einen Socket an einen Downlink. Diese Klasse ist die sendende Hälfte eines
...
public class Uplink {
  ...
  /**
   * Sendet eine Nachricht über den Socket. Sie wird am anderen Ende des Kommunikationskanals von
   * einem Downlink empfangen.
