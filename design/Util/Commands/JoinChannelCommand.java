...
public class JoinChannelCommand implements Command {
    /**
     * Konstruktor. Erzeugt einen Befehl zum Betreten eines Channels mit den dazu benötigten Daten. Dieser Befehl kann nur von
     * einem ClientServant verarbeitet werden.
