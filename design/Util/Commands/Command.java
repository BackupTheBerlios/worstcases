...
/**
 * Interface für alle Befehle, die beispielsweise  zwischen 
 * Client und ClientServant ausgetauscht werden.
 */
public interface Command extends Serializable {
  /**
   * Diese Methode wird ausgeführt, sowie ein Befehl (Command) bei 
   * seinem Empfänger ankommt. Ein Befehl enthält die zu seiner
