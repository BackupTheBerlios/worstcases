...
class DataBaseIO {
  ...
  private String userToString(User paramUser) {
    ...
    Debug.println("DataBaseIO: " + tmpString);
  ...
  private User stringToUser(String userSet) {
    ...
    Debug.println("DataBaseIO: " + tmpUser);
  ...
  private Channel stringToChannel(String channelSet) {
    ...
    Debug.println("DataBaseIO: " + tmpChannel);
  ...
  public synchronized void loadFromDisk()
    ...
    Debug.println("DataBaseIO: channeldb loaded");
    ...
    tmpBufferedReader.close();
    Debug.println("DataBaseIO: userdb loaded");
  }
