...
class DataBaseIO {
    ...
    private User stringToUser(String userSet) {
        ...
        return (
            new User(name, password, false, isAdmin, allowedChannelStringList,this.userAdministration));
    }
    ...
    private Channel stringToChannel(String channelSet) {
        ...
        return (
            new Channel(name, allowedForGuests, allowedUserStringList));
    }
    ...
    public void setChannelAdministration(ChannelAdministration channelAdministration) {
