...
public class ClientServant implements Util.DownlinkOwner {
    ...
    * @param msg Nachricht
     ...
     * sendet ggf. joinChannelErrorCommand, loginErrorCommand()
     * Benutzt user.getCurrentChannel() und Channel.getCurrentUserEnum(),
     * getClientServant()
     * um bei den verantwortlichen ClientServants ein sendMsgFromChannel()
     * aufzurufen.
     ...
     *  Sendet SetCurrentChannelDataCommand
     ...
     * Sendet SetCurrentUserDataCommand
    ...
    /** setServer setzt server und benachrichtigt das betroffene
      * Serverobjekt mittels removeFromClientServantList und
      * addToClientServantList
...
public class ClientServant implements Util.DownlinkOwner {
  ...
  public void loginUser(String name, String password) {
    ...
    if (tmpUser == null) {
      ...
      Debug.println("ClientServant: User " + this.user.getName() + " logged in");
      this.setUser(tmpUser);
    ...
    if (this.user != null) {
      if (this.user.getCurrentChannel() != null) {
        ...
        while (enum.hasMoreElements()) {
          ...
          tmpUser.getClientServant().sendMsgFromChannel(tmpUser.getName(),
                  msg);
        }
      } else {
        this.sendCommand(new JoinChannelErrorCommand());
  ...
  public void sendCurrentChannelData() {
    ...
    this.sendCommand(new Util.Commands
      .SetCurrentChannelDataCommand(this.user.getCurrentChannel()
        .getName(), this.user.getCurrentChannel().getCurrentUserNames()));
  }
  ...
  public void sendCurrentUserData() {
    ...
    this.sendCommand(new Util.Commands
      .SetCurrentUserDataCommand(this.user.getName(), this.user
        .getAllowedChannelNames()));
  }
