...
public class Client implements de.tu_bs.juliet.util.DownlinkOwner {
    ...
    /**
     * šber den Downlink ist der Client in der Lage, Nachrichten vom Client-
     ...
     * direkt an den Uplink übergeben. šber diese Methode läuft alles, was der
     ...
     * wird vom Downlink an diese Methode übergeben und sie sorgt dafür, da˜ der
     ...
     * übergeben und sie sorgt dafür, da˜ der empfangene Text in der GUI
    ...
    public synchronized final void stopClient() {
        ...
        // leert/schlie˜t die Fenster der grafischen Oberfläche
        this.gui.clearGui();
    }
}
