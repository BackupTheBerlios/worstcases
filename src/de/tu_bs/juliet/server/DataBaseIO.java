 ...
 * und zu speichern. Au˜erdem wird dafür gesorgt, dass für den Betrieb die
...
class DataBaseIO {
    ...
    private String userToString( User paramUser ) {
        ...
        // in tmpString wird Name, Pa˜wort und IsAdmin gespeichert
    ...
    private User stringToUser( String userSet ) {
        ...
        // Pa˜wort wird dem String entnommen
