...
/**
 * Ein Channeldatensatz. Eine Instanz dieser Klasse kann 
 * wichtige Channeldaten wie beispielsweise
 * berechtigte User oder im Channel befindliche User speichern.
 * Au˜erdem stehen Methoden zur Verfügung, mit denen Listen der berechtigten
...
class Channel {
     ...
     * user.removeFromAllowedChannelList(this), d.h. Gäste werden aus dem
     * Channel entfernt, wenn dieser nicht mehr für Gäste freigegeben ist.
     */
    ...
    /**
     * Die Namensliste als Vector von Strings der berechtigten Benutzer 
     * wird zurückgegeben (keine Gäste).
    ...
    /** Gibt eine Aufzählung der aktuellen Benutzerobjekte
      * im Channel zurück. Benutzt Helper.vectorCopy() */
    ...
    public synchronized void setAllowedUserList( Enumeration enumAllowedUser ) {
        ...
        // alle User aus enum hinzufügen, diese zusätzlich in tmpList speichern
        while ( enum.hasMoreElements() ) {
            tmpUser = ( User ) enum.nextElement();
        ...
        /*
         * alle Benutzer aus allowedUserList entfernen, die nicht in
         * enumAllowedUser (also tmpList) stehen
         */
    ...
    /**
     * Eine Namensliste als Vector von Strings 
     * der aktuellen Benutzer wird zurückgegeben. Benutzt
    ...
    public Vector getCurrentUserNames() {
        ...
        //alle Namen in tmpVector sammeln
        while ( enum.hasMoreElements() ) {
    ...
    /** Liefert eine Aufzählung der aktuellen Benutzer.
    ...
    public void setCurrentUserList( Enumeration enumCurrentUser ) {
        ...
        /*
         * alle Benutzer, die nicht in tmpList, also in enumCurrentUser,
         * stehen aus der Liste entfernen
         */
    ...
    /**
     * Informiert die Clients der aktuellen Benutzer 
     * im Channel über Veränderungen im Channel mittels 
     * getCurrentUserEnum(),
