...
public class ChatGui extends java.applet.Applet {
     ...
     */ 
    //FIXME: geh”rt eigentlich in die Klasse AdminGUI.
    ...
    public synchronized void setChannelData( String channelName,
        ...
        if ( this.channelAdminGUI.getIsCopy() ) {
            this.channelAdminGUI.channelName.setText( channelName + " [Kopie]" );
        } else {
    ...
    public void setUserData( String userName, String password, boolean isAdmin,
        ...
        if ( this.userAdminGUI.getIsCopy() ) {
            this.userAdminGUI.loginName.setText( userName + " [Kopie]" );
        } else {
