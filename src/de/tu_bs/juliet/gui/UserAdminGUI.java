...
public class UserAdminGUI extends java.awt.Frame {
    ...
    /** Das ChatGui, zu dem dieses UserAdminGUI geh”rt.*/
    ChatGui chatGui;
    ...
    /**
     * Diese Methode erm”glicht die Verwendung von angezeigten Benutzerdaten für
     * das Anlegen eines neuen Benutzers.
     */
    private void copyUser() {

        isNewUser = true;  // Attribut wird für das Speichern ben”tigt
        isCopy = true;
    ...
    /**
     * Diese Methode erm”glicht das Editieren eines vorhandenen Benutzers und
     * wird auÿerdem verwendet, um sich die Benutzerdaten anzeigen zu lassen.
     */
    private void editUser() {

        isNewUser = false;  // Attribut wird für das Speichern ben”tigt
        isCopy = false;
    ...
    /** Schlieÿt das Applikationsframe. */
