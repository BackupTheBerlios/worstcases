...
/**
 * Der Frame ChannelAdminGUI enthält die Funktionen des GUI, um alle
...
public class ChannelAdminGUI extends java.awt.Frame {
    ...
    /** Wurde die Funktion Kopieren verwendet? */
    private boolean isCopy = false;
    /** Maximale Länge eines Channel-Namens. */
    private int maxLength = 50;
    /** Das ChatGui, zu dem dieses ChannelAdminGUI geh”rt. */
    ChatGui chatGui;
     ...
     * und fügt einen WindowListener hinzu, der das Schlieÿen des Frames
     * erm”glicht.
     */
    ...
    /**
     * Klassische Get-Methode: wird von der ChatGUI benötigt, um
     * die Channeldaten richtig zu setzen 
     */
    ...
    /**
     * Diese Methode erm”glicht die Verwendung von angezeigten Channeldaten 
     * für das Anlegen eines neuen Channels.
     */
    private void copyChannel() {

        isNewChannel = true;  // Attribut wird für das Speichern ben”tigt
        isCopy = true;
    ...
    /**
     * Diese Methode erm”glicht das Editieren eines vorhandenen Channels 
     * und wird auÿerdem verwendet, um sich die Channeldaten anzeigen zu lassen.
     */
    private void editChannel() {

        isNewChannel = false;  // Attribut wird für das Speichern ben”tigt
        isCopy = false;
    ...
    /** Schlieÿen des Applikationsframes. */
