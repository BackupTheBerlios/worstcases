 ...
 * zu können. Der Benutzer bedient den Client nicht direkt, sondern über ein GUI. Der Client
 * leitet alle Nachrichten und Aktionen des Benutzers an seinen ClientServant weiter, und verarbeitet dessen Antworten.
 */
public class Client implements Util.DownlinkOwner {
     ...
     * dort mit den entsprechenden Methoden verarbeitet. Benutzt JoinChannelCommand()
     */
     ...
     * Der Client und seine GUI werden in den Zustand zurückversetzt, der nach dem Login des Users bestand.
     */
    public synchronized final void joinChannelError() {
    }

    /**
     * Trennt die Verbindung des Clients zum Server. Dazu werden die Referenzen auf das Uplink- bzw. Downlinkobjekt
    ...
    /**
     * Über den Downlink ist der Client in der Lage, Nachrichten vom Client- Servant zu empfangen.
     ...
     * Methode sorgt dafür, das der Benutzer eine Fehlermeldung bekommt und zum Loginscreen
     * zurückgelangt. Ruft stopClient() auf
     */
     ...
     * Benutzer wird zur Auswahl eines neuen Channels aufgeordert. Sendet ein LeaveChannelCommand().
     */
    ...
    /**
     * Meldet den Benutzer an. Name und Passwort werden per Methode sendCommand an den ClientServant
     * gesendet. Sendet LoginCommand().
     */
    ...
    public synchronized final void sendMsgToUser(String name, String msg) {
        this.sendCommand(
            new SendMsgToUserCommand(name, msg));
     ...
     * übergeben und sie sorgt dafür, daß der empfangene Text in der GUI erscheint und zum channelMsgBuffer hinzugefügt wird.
     */
