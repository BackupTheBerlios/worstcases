...
class ClientServantWatchDog extends Thread {
    ...
    public void run() {
        ...
        Debug.println(Debug.MEDIUM, this + ": watching: timeToLive: " + this.timeToLive + " updateDelay: " + this.updateDelay);
        while (!stop) {
            ...
            while (enum.hasMoreElements()) {
                ...
                if ((java.lang.System.currentTimeMillis() - tmpClientServant.getAliveStamp()) > timeToLive) {
                    ...
                    Debug.println(Debug.MEDIUM, this + ": " + tmpClientServant + ": stopped");
                }
            }
            try {
                sleep(updateDelay);
