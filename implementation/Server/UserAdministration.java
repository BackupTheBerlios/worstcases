...
class UserAdministration {
            ...
            if (tmpUser == null) {
                ...
                if ((tmpUser.getPassword().compareTo(password) == 0) && (!tmpUser.isLoggedIn())) {
                    ...
                    if (!tmpUser.isAdmin() && (numCurrentUsers >= maxUsers)) {
                        ...
                        Debug.println(Debug.MEDIUM, "UserAdministration: maxusers reached: " + maxUsers);
                    ...
                    Debug.println(Debug.MEDIUM, "UserAdministration: password wrong or user already logged in: " + name);
                    return null;
    ...
    public synchronized User loginGuest(String paramName) {
        if (paramName != null) {
            ...
            if ((this.getFromUserListByName(paramName) == null) && (this.numCurrentGuests < this.maxGuests)) {
                ...
                // wurde erreicht:
                Debug.println(Debug.MEDIUM, "UserAdministration: guestname " + paramName + " login failed"); // Fehlermeldung!
                return null;
            }
        }
    ...
    public synchronized void removeFromUserList(User paramUser) {
        if (this.userList.removeElement(paramUser)) {
            ...
            if (tmpClientServant != null) {
                tmpClientServant.sendErrorMsg("Ihr Account wurde vom Admin gelöscht!");
            }
            paramUser.removeYou();
